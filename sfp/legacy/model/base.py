...
from sfp.legacy.pipeline import (
    SelfForcingTrainingPipeline,
    BidirectionalTrainingPipeline,
)
from sfp.legacy.utils.loss import get_denoising_loss
from sfp.model.wan_wrapper import WanDiffusionWrapper, WanTextEncoder, WanVAEWrapper
    ...
    def _initialize_models(self, args, device):
        ...
        if self.training_target == "low_noise":
            ...
            distill_path = os.path.join(
                "./wan_models", getattr(args, "high_noise_distill_ckpt", "")
            )
...
class SelfForcingModel(BaseModel):
    ...
    def _consistency_backward_simulation(
        self, noise: torch.Tensor, y: torch.Tensor, **conditional_dict: dict
    ) -> torch.Tensor:
        """
