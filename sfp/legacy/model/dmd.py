from sfp.legacy.pipeline import SelfForcingTrainingPipeline
import torch.nn.functional as F
from typing import Optional, Tuple
import torch
from sfp.legacy.model.base import SelfForcingModel
...
class DMD(SelfForcingModel):
    ...
    def critic_loss(
        ...
        if self.training_target == "high_noise":
            self.scheduler.sigmas = self.scheduler.sigmas.to(
                noisy_generated_image.device
            )
            ...
            fake_image = (
                (1 - s) * (t - beta * beta) * noisy_generated_image
        ...
        critic_log_dict = {"critic_timestep": critic_timestep_id.detach()}
