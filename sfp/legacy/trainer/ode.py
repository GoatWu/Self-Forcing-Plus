import gc
import logging
from sfp.legacy.utils.dataset import ODERegressionLMDBDataset, cycle
from sfp.legacy.model import ODERegression
from collections import defaultdict
from sfp.legacy.utils.misc import set_seed
...
class Trainer:
    def __init__(self, config):
        ...
        assert config.distribution_loss == "ode", (
            ...
            wandb.log(
                {
                    ...
                    "ground_truth": wandb.Video(
                        ground_truth_video, caption="Ground Truth", fps=16, format="mp4"
                    ),
                },
                step=self.step,
            )
