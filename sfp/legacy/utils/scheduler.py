...
class SchedulerInterface(ABC):
    ...
    @abstractmethod
    def add_noise_high(self, clean_latent, noise, timestep, timestep_start):
        pass

    @abstractmethod
    def add_noise_low(self, clean_latent, noise, timestep, timestep_start):
        pass
...
if __name__ == "__main__":
    ...
    for step in target_timesteps:
        ...
        timestep_id = torch.argmin(
            (
                scheduler.timesteps.unsqueeze(0) - torch.tensor([step]).unsqueeze(1)
            ).abs(),
            dim=1,
        )
        print("================================================")
